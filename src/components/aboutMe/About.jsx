...
const About = () => {
  const description = [
    ...
    },
    {
      id: '2',
      side: 'right',
      text: 'Моим хобби уже долгое время является программирование. С 15 лет делал разного уровня проекты. Помимо основной деятельности у меня есть и другие увлечения: крипта, инвестиции, спорт, в прошлом профессиональный футболист, и т.д',
    },
    {
      id: '3',
      side: 'left',
